...
\Gls{RoR} makes an extensive use of the concept of \Gls{CoC} which is a software design paradigm which seeks to decrease the number of decisions that developers need to make, gaining simplicity
...
The application built for this project has been depolyed on the \textit{Heroku application platform}\footnote{\url{https://www.heroku.com/}} and its
online implementation is reachable
at the following \texttt{url}: \url{http://mitosis-detection.herokuapp.com/}.
...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {
      \includegraphics[width=0.98\textwidth]{./images/cr_MD_intro.png}
    };
...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {
      \includegraphics[width=0.88\textwidth]{./images/cr_MD_train.png}
    };
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \coordinate (a) at (0.01,0.15);
      \coordinate (b) at (0.01,0.63);
      \coordinate (c) at (0.99,0.15);
      \coordinate (d) at (0.99,0.63);
...
a commitment over the type of current image: towards \textit{C0} or towards \textit{C1}.

\begin{figure}[!hbt]
  \centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {
      \includegraphics[width=0.88\textwidth]{./images/cr_MD_eval0.png}
    };
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{figure}[!hbt]
  \centering
	...
	\includegraphics[width=0.84\textwidth]{./images/cr_MD_eval_OK.png}
	\label{ch5:fig4:a}
    }\\
    %\hspace{1mm}
    \subfigure[negative Feedback]{
      \includegraphics[width=0.84\textwidth]{./images/cr_MD_eval_KO.png}
      \label{ch5:fig4:b}
    }
...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {
      \includegraphics[width=0.88\textwidth]{./images/cr_MD_eval_act_perf.png}
    };
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{figure}[!hbt]
  \centering
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
	\includegraphics[width=0.92\textwidth]{./images/cr_MD_comments.png}
    };
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{figure}[!hbt]
  \centering
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
	\includegraphics[width=0.92\textwidth]{./images/cr_MD_user_res.png}
    };
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \coordinate (a) at (0.0,0.0);
      \coordinate (b) at (1.0,1.0);
...
\begin{figure}[!hbt]
  \centering
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
	\includegraphics[width=0.92\textwidth]{./images/cr_MD_data_all.png}
    };
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \coordinate (a) at (0.0,0.0);
      \coordinate (b) at (1.0,1.0);
...
\begin{figure}[!hbt]
  \centering
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
	\includegraphics[width=0.92\textwidth]{./images/cr_MD_data_dl.png}
    };
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \coordinate (a) at (0.0,0.0);
      \coordinate (b) at (1.0,1.0);
...
\begin{figure}[!hbt]
  \centering
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
	\includegraphics[width=0.92\textwidth]{./images/cr_MD_data_comments.png}
    };
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \coordinate (a) at (0.0,0.0);
      \coordinate (b) at (1.0,1.0);
...
Some extracts of the source code of the project can be found in Appendix \ref{appendixC}. The entire project source code is maintained at
