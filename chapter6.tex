...
\begin{figure}[!htb]
  \centering
    \subfigure[SVM - ROC]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig1/SVM_ROC_MSi_crop.png}
      \label{ch6:fig1:a}
    }
    \hspace{1mm}
    \subfigure[RF - ROC]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig1/RF_ROC_MSi_crop.png}
      \label{ch6:fig1:b}
    }    
    \caption{ROC curves for \texttt{MSi} feature classification}
    \label{ch6:fig1}
...
\begin{figure}[!htb]
  \centering
    \subfigure[SVM - ROC]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig2/SVM_ROC_MSiHLV_crop.png}
      \label{ch6:fig2:a}
    }    
    \hspace{1mm}
    \subfigure[RF - ROC]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig2/RF_ROC_MSiHLV_crop.png}
      \label{ch6:fig2:b}
    }
...
\begin{figure}[!htb]
  \centering
    \subfigure[MSiVHL - AUC]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig8/MSiVHL_sortAUC_crop.png}
      \label{ch6:fig8:a}
    }
    \hspace{1mm}
    \subfigure[MSiVHL - accuracy]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig8/MSiVHL_sortAccuracy_crop.png}
      \label{ch6:fig8:b}
    }    
...
\begin{figure}[!htb]
  \centering
    \subfigure[MSiVHR - AUC]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig8/MSiVHR_sortAUC_crop.png}
      \label{ch6:fig9:a}
    }
    \hspace{1mm}
    \subfigure[MSiVHR - accuracy]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig8/MSiVHR_sortAccuracy_crop.png}
      \label{ch6:fig9:b}
    }    
...
\begin{figure}[!htb]
  \centering
    \subfigure[MSiVHU - AUC]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig8/MSiVHU_sortAUC_crop.png}
      \label{ch6:fig10:a}
    }
    \hspace{1mm}
    \subfigure[MSiVHU - accuracy]{
      \includegraphics[width=0.46\textwidth]{./images/Ch6/Fig8/MSiVHU_sortAccuracy_crop.png}
      \label{ch6:fig10:b}
    }    
...
\begin{figure}[!htb]
  \centering
    \subfigure[RF iVHL - AUC]{
      \includegraphics[width=0.84\textwidth]{./images/Ch6/Fig11/iVHL_RF_AUC.png}
      \label{ch6:fig12:a}
    }
    \\
    \subfigure[RF iVHL - accuracy]{
      \includegraphics[width=0.84\textwidth]{./images/Ch6/Fig11/iVHL_RF_acc.png}
      \label{ch6:fig12:b}
    }    
...
\begin{figure}[!htb]
  \centering
    \subfigure[RF MiVHU - AUC]{
      \includegraphics[width=0.84\textwidth]{./images/Ch6/Fig11/MiVHU_RF_AUC.png}
      \label{ch6:fig13:a}
    }
    \\
    \subfigure[RF MiVHU - accuracy]{
      \includegraphics[width=0.84\textwidth]{./images/Ch6/Fig11/MiVHU_RF_acc.png}
      \label{ch6:fig13:b}
    }    
...
\begin{figure}[!htb]
  \centering
    \subfigure[RF MSVHR - AUC]{
      \includegraphics[width=0.84\textwidth]{./images/Ch6/Fig11/MSVHR_RF_AUC.png}
      \label{ch6:fig14:a}
    }
    \\
    \subfigure[RF MSVHR - accuracy]{
      \includegraphics[width=0.84\textwidth]{./images/Ch6/Fig11/MSVHR_RF_acc.png}
      \label{ch6:fig14:b}
    }    
...
\begin{figure}[!htb]
  \centering
    \subfigure[PCA MSidHLV - AUC]{
      \includegraphics[width=0.86\textwidth]{./images/exp06/pca_AUC_MSidHLV.png}
      \label{ch6:fig15:a}
    }
    \\
    \subfigure[PCA MSidHLV - accuracy]{
      \includegraphics[width=0.86\textwidth]{./images/exp06/pca_acc_MSidHLV.png}
      \label{ch6:fig15:b}
    }    
...
\begin{figure}[!htb]
  \centering
    \subfigure[PCA MSidHUV - AUC]{
      \includegraphics[width=0.86\textwidth]{./images/exp06/pca_AUC_MSidHUV.png}
      \label{ch6:fig16:a}
    }
    \\
    \subfigure[PCA MSidULV - accuracy]{
      \includegraphics[width=0.86\textwidth]{./images/exp06/pca_acc_MSidHUV.png}
      \label{ch6:fig16:b}
    }    
...
The results show a generally better performance of \Gls{RF} than \Gls{SVM}, even if, at high number of components ($>250$), \Gls{SVM} still finds useful information
...
\noindent In this case we used \textit{AUC} as a measure of performance. 
...
\begin{figure}[!ht]
 \begin{center}
  \includegraphics[width=0.98\textwidth]{./images/exp07/SVM_AUC_H.png}
